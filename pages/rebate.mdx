...
<Callout type="warning" emoji="⚠️">
  Currently only `swap*` are fully supported, with additional function calls to be supported soon
</Callout>
...
> **`<` and `>` denote discrete objects**

> **`[`and `]` denote an array within a discrete object**

### Parameters

transactionWeight = $function_calls[]

bundleTxs = transactionWeight<1,2,3...>
...
### Gas Pricing Response

> via [api.txprice.com](https://api.txprice.com)
